#This script contains functions for tokenizing input sentences, stemming words, 
#creating a bag-of-words representation of tokenized patterns, and generating a chatbot response based on model predictions.
#The `generate_chatbot_response` function takes a chatbot model, a user request, and a list of intent tags as input,
#then returns the predicted probability and corresponding intent tag based on the model's prediction for the user request.
