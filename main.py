#This code snippet creates and trains an artificial neural network (ANN) for a chatbot using TensorFlow and Keras,
 #with three layers. It preprocesses the data, defines the architecture, compiles the model with specified loss and optimizer,
 #trains the model, and finally saves the trained model into a file named 'Barista.keras'.
